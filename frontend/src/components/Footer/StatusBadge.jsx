...
export default function StatusBadge({ label, status = 'Online', color = 'emerald' }) {
  ...
  return (
    <div className="flex items-center justify-between gap-2 px-2.5 py-1.5 rounded-xl bg-[#000000] border border-slate-800 text-[11px] font-mono whitespace-nowrap">
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <span className={`font-bold uppercase tracking-wider text-[10px] ${colorStyles}`}>
          {status}
        </span>
      </div>
    </div>
